...
  return (
    // FIX: Apply conditional height. On small screens (default), use 16:9 ratio based on width.
    // On medium screens and up (md:), revert to full viewport height (h-screen).
    <section 
        ref={sectionRef}
        className="relative w-full overflow-hidden bg-black flex items-center justify-center
                   aspect-video sm:aspect-auto sm:h-auto md:h-screen"
    >
      
      {/* ---------------------------------------------------------------------------
          LOADER OVERLAY
